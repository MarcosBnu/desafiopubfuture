    ...
    function listar (Usi) {
        ...
        for (var i in Usi) { //i vale a posição no vetor
          //lin='<div class="card cores10card col-3">'+
            lin='<div style="margin-left: 20px;">'+
                '<h4 class="card-title">' + Usi[i].id +'</h4>'+
                '<p class="card-text">'+ Usi[i].Nome_usuario + '</p>'+
                '<p class="card-text">'+ Usi[i].Status + '</p>'+
                '<p class="card-text">'+ Usi[i].financeira + '</p>'+
                '</div>';
